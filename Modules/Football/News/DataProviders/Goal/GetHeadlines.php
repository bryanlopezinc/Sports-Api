...
final class GetHeadlines extends GoalNews implements NewsSourceInterface
{
    private const ALIAS = 'headlinesFromGoalWebsite';
    ...
    {
        return 'https://www.goal.com/en/news/1';
    }
